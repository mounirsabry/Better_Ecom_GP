...
export class SaveProfileChangesService {
  ...
  {
    return this.httpClient.patch<any>('https://localhost:44361/profile/ChangePassword' ,{"UserID" : +localStorage.getItem('ID') ,"Old_password" : oldPassword, "New_password" : newPassword})
  }
}
